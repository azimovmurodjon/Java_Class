...
class InventoryManagementSystem {
    private List<Product1> products;             // List to store products
    private Map<Product1, Integer> inventory;    // HashMap to store product quantities
    ...
    public void addProduct(Product1 product, int quantity) {
    ...
    public static void main(String[] args) {
        ...
        ims.addProduct(new Product1("Laptop", 999.99), 10);
        ims.addProduct(new Product1("Smartphone", 499.99), 20);
        ims.addProduct(new Product1("Headphones", 49.99), 30);
        ...
        Product1 selectedProduct = null;
        for (Product1 product : ims.products) {
